...
set_property BEL CFF [get_cells {u_ila_0/inst/ila_core_inst/u_trig/U_TM/N_DDR_MODE.G_NMU[0].U_M/allx_typeA_match_detection.ltlib_v1_0_2_allx_typeA_inst/probeDelay1_reg[0]}]
set_property BEL C6LUT [get_cells {u_ila_0/inst/ila_core_inst/u_trig/U_TM/N_DDR_MODE.G_NMU[0].U_M_i_1}]
set_property LOC SLICE_X39Y5 [get_cells {u_ila_0/inst/ila_core_inst/u_trig/U_TM/N_DDR_MODE.G_NMU[0].U_M/allx_typeA_match_detection.ltlib_v1_0_2_allx_typeA_inst/probeDelay1_reg[0]}]
set_property LOC SLICE_X39Y5 [get_cells {u_ila_0/inst/ila_core_inst/u_trig/U_TM/N_DDR_MODE.G_NMU[0].U_M_i_1}]
set_property BEL A6LUT [get_cells {u_ila_0/inst/ila_core_inst/shifted_data_in_reg[7][0]_srl8}]
set_property LOC SLICE_X46Y1 [get_cells {u_ila_0/inst/ila_core_inst/shifted_data_in_reg[7][0]_srl8}]
